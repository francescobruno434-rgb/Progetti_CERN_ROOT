...
double par_in_x[]={13.7, 32.4, 1, 0.005};
...
double par_in_a[]={6.75, 32.4, 1, 0.005};
double der_a=x_ris_a->Derivative(13.7, par_in_a);
...
double par_in_b[]={6.75, 13.7, 1.1, 0.005};
double der_b=x_ris_b->Derivative(32.4, par_in_b);
...
double par_in_c[]={6.75, 13.7, 32.4, 0.005};
double der_c=x_ris_c->Derivative(1, par_in_c);
...
double par_in_d[]={6.75, 13.7, 32.4, 1 };
double der_d=x_ris_d->Derivative(0.005, par_in_d);
cout<<"La derivata della x rispetto alla d vale " << der_d<<endl;


//RISULTATO FINALE
double errore= err(der_y, 0.05, der_a, 0.2, der_b, 0.3, der_c, 0.2, der_d, 0.009);
double param[]={13.7, 32.4, 1, 0.005};
double x[]={6.75};
double valore= x_rising->EvalPar(x, param);

cout<<"la funzione falling vale "<<valore<<endl;
