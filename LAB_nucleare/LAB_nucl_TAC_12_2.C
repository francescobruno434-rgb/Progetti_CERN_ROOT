...
void LAB_nucl_TAC_12_2(){
    ...
    TF1* fit= new TF1("fit", "gaus(0)+gaus(3)+gaus(6)", 100, 280 ); //i parametri della gaussiana sono ampiezza, media e stdv (in ordine)
    fit->SetParameters(200, 190, 25, 300, 200, 20, 100, 210, 20 );
