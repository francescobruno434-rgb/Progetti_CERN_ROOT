...
void LAB_nucl_efficienza_3(){
    ...
    for(int i=0; i<numero_elementi; i++){
        double HV_1= HV[i];
        double err_HV_1= err_HV[i];
        double eff_1= eff[i];
        double err_eff_1= err_eff[i];
        double coin_singole_1= coin_singole[i];
        double coin_doppie_1= coin_doppie[i];
        double coin_triple_1= coin_triple[i];
         double err_coin_singole_1= err_coin_singole[i];
        double err_coin_doppie_1= err_coin_doppie[i];
        double err_coin_triple_1= err_coin_triple[i];
        cout<< "$ ( "<< HV_1<< " \\pm  "<< err_HV_1<< "  )$  & $ (  " << eff_1<< " \\pm "<< err_eff_1<< "  )$ & $ (" << coin_singole_1<< " \\pm " <<  err_coin_singole_1 <<   "  )$ & $ (" << coin_doppie_1<< " \\pm " << err_coin_doppie[i] << "  )$ & $ (" << coin_triple[i] << " \\pm " << err_coin_triple_1 <<"  )$ \\\\ \\hline "<<endl;
    }
