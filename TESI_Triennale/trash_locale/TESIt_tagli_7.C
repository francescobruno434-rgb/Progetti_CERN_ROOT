...
void TESIt_tagli_7(){
    ...
    for(int i=0; i<len; i++){
        tree->GetEntry(i);
        if(charge<=0 && CascCosToPointingAngle>0.98 && V0CosPointingAngle>0.99 && DCAV0Daughters<0.3 && DCABachToPrimVtx<5 ){
    ...
    fit_massa_csi2->SetParameters(50, 1.32171, 0.003, 18510, -27100, 10000, 0);
    ...
    fit_massa_anti_csi->SetParameters(50, 1.32171, 0.003, 18510, -27100, 10000, 0);
    ...
    //
    TH1F* hanti_DCAV0Daughters= new TH1F("hanti_DCAV0Daughters","hanti_DCAV0Daughters",200, 0, 0.3);
    TH1F* hanti_DCAV0Daughters_fondo= new TH1F("hanti_DCAV0Daughters_fondo","hanti_DCAV0Daughters", 200, 0, 0.3);
    TH1F* hanti_DCAV0Daughters_segnale= new TH1F("hanti_DCAV0Daughters_segnale", "hanti_DCAV0Daughters",200, 0, 0.3);
    ...
    //
    TH1F* hanti_DCAV0ToPrimVtx= new TH1F("hanti_DCAV0ToPrimVtx","hanti_DCAV0ToPrimVtx",200, 0, 25);
    TH1F* hanti_DCAV0ToPrimVtx_fondo= new TH1F("hanti_DCAV0ToPrimVtx_fondo","hanti_DCAV0ToPrimVtx", 200, 0, 25);
    TH1F* hanti_DCAV0ToPrimVtx_segnale= new TH1F("hanti_DCAV0ToPrimVtx_segnale","hanti_DCAV0ToPrimVtx", 200, 0, 25);
    ...
    //
    TH1F* hanti_DCAPosToPrimVtx= new TH1F("hanti_DCAPosToPrimVtx","hanti_DCAPosToPrimVtx",200, 0, 38);
    TH1F* hanti_DCAPosToPrimVtx_fondo= new TH1F("hanti_DCAPosToPrimVtx_fondo","hanti_DCAPosToPrimVtx", 200, 0, 38);
    TH1F* hanti_DCAPosToPrimVtx_segnale= new TH1F("hanti_DCAPosToPrimVtx_segnale","hanti_DCAPosToPrimVtx", 200, 0, 38);
    ...
    //
    TH1F* hanti_DCANegToPrimVtx= new TH1F("hanti_DCANegToPrimVtx","hanti_DCANegToPrimVtx",200, 0, 38);
    TH1F* hanti_DCANegToPrimVtx_fondo= new TH1F("hanti_DCANegToPrimVtx_fondo","hanti_DCANegToPrimVtx", 200, 0, 38);
    TH1F* hanti_DCANegToPrimVtx_segnale= new TH1F("hanti_DCANegToPrimVtx_segnale","hanti_DCANegToPrimVtx", 200, 0, 38);
    ...
    //
    TH1F* hanti_CascCosToPointingAngle= new TH1F("hanti_CascCosToPointingAngle","hanti_CascCosToPointingAngle",200, 0.98, 1.002);
    TH1F* hanti_CascCosToPointingAngle_fondo= new TH1F("hanti_CascCosToPointingAngle_fondo","hanti_CascCosToPointingAngle", 200, 0.98, 1.002);
    TH1F* hanti_CascCosToPointingAngle_segnale= new TH1F("hanti_CascCosToPointingAngle_segnale","hanti_CascCosToPointingAngle", 200, 0.98, 1.002);
    ...
    //
    TH1F* hanti_CascDCAtoPVxy= new TH1F("hanti_CascDCAtoPVxy","hanti_CascDCAtoPVxy",200, 0, 11);
    TH1F* hanti_CascDCAtoPVxy_fondo= new TH1F("hanti_CascDCAtoPVxy_fondo","hanti_CascDCAtoPVxy", 200, 0, 11);
    TH1F* hanti_CascDCAtoPVxy_segnale= new TH1F("hanti_CascDCAtoPVxy_segnale","hanti_CascDCAtoPVxy", 200, 0, 11);
    ...
    //
    TH1F* hanti_CascRadius= new TH1F("hanti_CascRadius","hanti_CascRadius",200, 0, 95);
    TH1F* hanti_CascRadius_fondo= new TH1F("hanti_CascRadius_fondo","hanti_CascRadius", 200, 0, 95);
    TH1F* hanti_CascRadius_segnale= new TH1F("hanti_CascRadius_segnale","hanti_CascRadius", 200, 0, 95);
    ...
    //
    TH1F* hanti_V0CosPointingAngle= new TH1F("hanti_V0CosPointingAngle","hanti_CascRadius",200, 0.99, 1.001);
    TH1F* hanti_V0CosPointingAngle_fondo= new TH1F("hanti_V0CosPointingAngle_fondo", "hanti_CascRadius",200, 0.99,1.001);
    TH1F* hanti_V0CosPointingAngle_segnale= new TH1F("hanti_V0CosPointingAngle_segnale","hanti_CascRadius", 200, 0.99, 1.001);
    ...
    //
    TH1F* hanti_V0Radius= new TH1F("hanti_V0Radius","hanti_CascRadius",200, 0, 200);
    TH1F* hanti_V0Radius_fondo= new TH1F("hanti_V0Radius_fondo", "hanti_CascRadius",200, 0, 200);
    TH1F* hanti_V0Radius_segnale= new TH1F("hanti_V0Radius_segnale","hanti_CascRadius", 200, 0, 200);
