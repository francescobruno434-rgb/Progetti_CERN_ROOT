...
void TESIt_tagli_antiparticelle_7_estetico(){
    //
    //
    ...
    for(int i=0; i<len; i++){
        tree->GetEntry(i);
        if(charge<=0 && CascCosToPointingAngle>0.98 && V0CosPointingAngle>0.99 && DCAV0Daughters<0.3 && DCABachToPrimVtx<5 &&  DCAV0Daughters<0.05 &&  DCAV0ToPrimVtx<2 && DCAPosToPrimVtx <3 && DCANegToPrimVtx <3 && CascCosToPointingAngle > 0.99 && CascDCAtoPVxy <1 && CascRadius <20 && V0CosPointingAngle>0.995 &&  V0Radius <60){
    ...
    fit_massa_csi2->SetParLimits(0, 12, 300);
    ...
    fit_massa_anti_csi->SetParameters(25, 1.32171, 0.003, 6371.5,  -9435, 3500, 0);
    fit_massa_anti_csi->SetParLimits(1, 1.32, 1.322);
    fit_massa_anti_csi->SetParLimits(0, 12, 1000);
    ...
    //
    TH1F* hanti_DCACascDaughters= new TH1F("hanti_DCACascDaughters","hanti_DCACascDaughters",200, 0, 0.51);
    ...
    hanti_DCACascDaughters->SetLineColor(4);  // blu l'originale
    hanti_DCACascDaughters_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCACascDaughters_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_DCABachToPrimVtx= new TH1F("hanti_DCABachToPrimVtx","hanti_DCABachToPrimVtx",200, 0, 5);
    TH1F* hanti_DCABachToPrimVtx_fondo= new TH1F("hanti_DCABachToPrimVtx_fondo","hanti_DCABachToPrimVtx", 200, 0, 5);
    TH1F* hanti_DCABachToPrimVtx_segnale= new TH1F("hanti_DCABachToPrimVtx_segnale","hanti_DCABachToPrimVtx", 200, 0, 5);
    hanti_DCABachToPrimVtx->SetLineColor(4);  // fucsia l'originale
    hanti_DCABachToPrimVtx_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCABachToPrimVtx_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_DCAV0Daughters= new TH1F("hanti_DCAV0Daughters","hanti_DCAV0Daughters",200, 0, 0.05);
    TH1F* hanti_DCAV0Daughters_fondo= new TH1F("hanti_DCAV0Daughters_fondo","hanti_DCAV0Daughters", 200, 0, 0.05);
    TH1F* hanti_DCAV0Daughters_segnale= new TH1F("hanti_DCAV0Daughters_segnale", "hanti_DCAV0Daughters",200, 0, 0.05);
    hanti_DCAV0Daughters->SetLineColor(4);  // fucsia l'originale
    hanti_DCAV0Daughters_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCAV0Daughters_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_DCAV0ToPrimVtx= new TH1F("hanti_DCAV0ToPrimVtx","hanti_DCAV0ToPrimVtx",200, 0, 2);
    TH1F* hanti_DCAV0ToPrimVtx_fondo= new TH1F("hanti_DCAV0ToPrimVtx_fondo","hanti_DCAV0ToPrimVtx", 200, 0, 2);
    TH1F* hanti_DCAV0ToPrimVtx_segnale= new TH1F("hanti_DCAV0ToPrimVtx_segnale","hanti_DCAV0ToPrimVtx", 200, 0, 2);
    hanti_DCAV0ToPrimVtx->SetLineColor(4);  // fucsia l'originale
    hanti_DCAV0ToPrimVtx_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCAV0ToPrimVtx_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_DCAPosToPrimVtx= new TH1F("hanti_DCAPosToPrimVtx","hanti_DCAPosToPrimVtx",200, 0, 3);
    TH1F* hanti_DCAPosToPrimVtx_fondo= new TH1F("hanti_DCAPosToPrimVtx_fondo","hanti_DCAPosToPrimVtx", 200, 0, 3);
    TH1F* hanti_DCAPosToPrimVtx_segnale= new TH1F("hanti_DCAPosToPrimVtx_segnale","hanti_DCAPosToPrimVtx", 200, 0, 3);
    hanti_DCAPosToPrimVtx->SetLineColor(4);  // fucsia l'originale
    hanti_DCAPosToPrimVtx_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCAPosToPrimVtx_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_DCANegToPrimVtx= new TH1F("hanti_DCANegToPrimVtx","hanti_DCANegToPrimVtx",200, 0, 3);
    TH1F* hanti_DCANegToPrimVtx_fondo= new TH1F("hanti_DCANegToPrimVtx_fondo","hanti_DCANegToPrimVtx", 200, 0, 3);
    TH1F* hanti_DCANegToPrimVtx_segnale= new TH1F("hanti_DCANegToPrimVtx_segnale","hanti_DCANegToPrimVtx", 200, 0, 3);
    hanti_DCANegToPrimVtx->SetLineColor(4);  // fucsia l'originale
    hanti_DCANegToPrimVtx_fondo->SetLineColor(2); //rosso il fondo
    hanti_DCANegToPrimVtx_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_CascCosToPointingAngle= new TH1F("hanti_CascCosToPointingAngle","hanti_CascCosToPointingAngle",200, 0.99, 1.002);
    TH1F* hanti_CascCosToPointingAngle_fondo= new TH1F("hanti_CascCosToPointingAngle_fondo","hanti_CascCosToPointingAngle", 200, 0.99, 1.002);
    TH1F* hanti_CascCosToPointingAngle_segnale= new TH1F("hanti_CascCosToPointingAngle_segnale","hanti_CascCosToPointingAngle", 200, 0.99, 1.002);
    hanti_CascCosToPointingAngle->SetLineColor(4);  // fucsia l'originale
    ...
    //
    TH1F* hanti_CascDCAtoPVxy= new TH1F("hanti_CascDCAtoPVxy","hanti_CascDCAtoPVxy",200, 0, 1);
    TH1F* hanti_CascDCAtoPVxy_fondo= new TH1F("hanti_CascDCAtoPVxy_fondo","hanti_CascDCAtoPVxy", 200, 0, 1);
    TH1F* hanti_CascDCAtoPVxy_segnale= new TH1F("hanti_CascDCAtoPVxy_segnale","hanti_CascDCAtoPVxy", 200, 0, 1);
    hanti_CascDCAtoPVxy->SetLineColor(4);  // fucsia l'originale
    hanti_CascDCAtoPVxy_fondo->SetLineColor(2); //rosso il fondo
    hanti_CascDCAtoPVxy_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_CascRadius= new TH1F("hanti_CascRadius","hanti_CascRadius",200, 0, 20);
    TH1F* hanti_CascRadius_fondo= new TH1F("hanti_CascRadius_fondo","hanti_CascRadius", 200, 0, 20);
    TH1F* hanti_CascRadius_segnale= new TH1F("hanti_CascRadius_segnale","hanti_CascRadius", 200, 0, 20);
    hanti_CascRadius->SetLineColor(4);  // fucsia l'originale
    hanti_CascRadius_fondo->SetLineColor(2); //rosso il fondo
    hanti_CascRadius_segnale->SetLineColor(3); //verde segnale
    //
    TH1F* hanti_V0CosPointingAngle= new TH1F("hanti_V0CosPointingAngle","hanti_CascRadius",200, 0.995, 1.001);
    TH1F* hanti_V0CosPointingAngle_fondo= new TH1F("hanti_V0CosPointingAngle_fondo", "hanti_CascRadius",200, 0.995,1.001);
    TH1F* hanti_V0CosPointingAngle_segnale= new TH1F("hanti_V0CosPointingAngle_segnale","hanti_CascRadius", 200, 0.995, 1.001);
    hanti_V0CosPointingAngle->SetLineColor(4);  // fucsia l'originale
    ...
    //
    TH1F* hanti_V0Radius= new TH1F("hanti_V0Radius","hanti_CascRadius",200, 0, 60);
    TH1F* hanti_V0Radius_fondo= new TH1F("hanti_V0Radius_fondo", "hanti_CascRadius",200, 0, 60);
    TH1F* hanti_V0Radius_segnale= new TH1F("hanti_V0Radius_segnale","hanti_CascRadius", 200, 0, 60);
    hanti_V0Radius->SetLineColor(4);  // fucsia l'originale
    ...
    for(int i=0; i<len; i++){
        tree->GetEntry(i);
        if(charge>=0 && CascCosToPointingAngle>0.98 && V0CosPointingAngle>0.99 && DCAV0Daughters<0.3 && DCABachToPrimVtx<5){//piglio solo le anti csi che hanno carica maggiore di 0
