...
void TESIt_tagli_particelle_vero(){
  ...
  c12->cd(1);
    ...
    //Printiamo matrici di covarianza
    cov_Pt1.Print();
    cov_Pt2.Print();
    cov_Pt3.Print();
    cov_Pt4.Print();
...
//
//scriviamo le varie funzioni gaussiane per i segnali dei vari Pt (forse non era necessario)
...
//NB: forse è meglio che faccio direttamente l'integrale 
